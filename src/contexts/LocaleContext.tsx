...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'page.deleteCustomerUnassignAndDelete': 'All employees will be unassigned first. Then all chats, loans, and customer data will be permanently deleted from the database (not archived).',
    ...
    'detail.assignedEmployeesOnLoan': 'Team on this loan (chat)',
  ...
  ar: {
    ...
    'page.deleteCustomerUnassignAndDelete': 'سيتم إلغاء تعيين جميع الموظفين أولاً. ثم حذف جميع المحادثات والقروض وبيانات العميل نهائياً من قاعدة البيانات (بدون أرشفة).',
    ...
    'detail.assignedEmployeesOnLoan': 'الفريق على هذا القرض (المحادثة)',
